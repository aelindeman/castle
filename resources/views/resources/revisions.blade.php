...
@section('title', 'Revisions of ' . e($resource->name) . ' - ' . e($resource->client->name) . ' - Clients - Castle')
...
@endsection
@section('content')
<div class="container item-revisions resource-revisions">
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
				...
				<li class="list-group-item revision">
					<header class="media">
						<section class="media-left">
							<form class="form-inline" action="{{ route('clients.resources.revisions.restore', ['client' => $resource->client->url, 'resource' => $resource->url, 'revision' => $history->id]) }}" method="post">
								{!! csrf_field() !!}
			...
			<div class="alert alert-info">
				This resource has no older versions.
			</div>
			@endif
