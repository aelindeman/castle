...
@section('title', 'Create document - Docs - Castle')
...
<div class="container item-editor document-editor">
	...
	<form class="form-horizontal" method="post" action="{{ route('docs.store') }}" enctype="multipart/form-data">
		{!! csrf_field() !!}
		...
		<fieldset>
			...
			<div class="form-group{{ $errors->has('clients') ? ' has-error has-feedback' : '' }}">
				...
				<div class="col-md-8">
					...
					<?php $oldClients = collect(old('clients')) ?>
		...
		<fieldset class="form-bottom-toolbar">
			...
			<div class="form-group">
				<div class="col-md-8 col-md-offset-2">
					...
					<a class="btn btn-default" href="{{ route('docs.index') }}">Cancel</a>
				</div>
			</div>
